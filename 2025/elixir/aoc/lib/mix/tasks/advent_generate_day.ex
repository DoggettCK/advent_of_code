...
defmodule Mix.Tasks.Advent.Generate.Day do
  ...
  Given a day between 1-12, generates a module, test file, and real/example
  input files.
  ...
  defp advent_day(day) when is_binary(day) do
    case Integer.parse(day) do
      {day, _} when day in 1..12 ->
        day

      _ ->
        raise ArgumentError, "provide a valid day number from 1-12"
    end
  end
end
